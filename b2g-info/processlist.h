...
public:
  ...
  /**
   * Get all of the non-B2G processes on the system.
   */
  const std::vector<Process*>& non_b2g_processes();

  /**
   * To classify all processes into b2g and non-b2g.
   */
  void processes_classify();
...
private:
  ...
  std::vector<Process*> m_non_b2g_processes;
